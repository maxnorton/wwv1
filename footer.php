					<footer class="footer" role="contentinfo">
						<div id="inner-footer" class="row collapse">
							<div class="medium-6 columns">
								<iframe src="https://www.google.com/maps/embed/v1/directions?key=AIzaSyBjfQzlCp5KTe5HLPtlbIwbjx2RDWayOAQ&mode=driving&origin=Los+Angeles,CA&destination=Whitewater+Voyages+-+Kern+Outdoor+Center,Kernville,CA&zoom=7" style="width: 100%; height: 100%; min-height: 450px; border: 0 none;"></iframe>
							</div>
							<div class="medium-6 columns">
					...
					<div class="lastrow">
						<div class="row">
							...
							<div class="medium-2 columns"><img src="/wp-content/themes/wwv1/assets/images/ra-logo-member.png" width="140" height="55" alt="Proud member of Rafting America" class="left" /></div>
